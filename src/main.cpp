...
private:
  ...
  // Detailed Wi-Fi connection status logging
...
{
  DBG_BEGIN(115200);
  // Wait briefly before starting (allows USB serial to stabilize)
  delay(200);
...
{
  app.loop();
  // Output status to the serial console every 2 seconds
